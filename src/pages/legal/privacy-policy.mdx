...
Actegon Solutions Kft. ("developer") built the Actegon.com app as an Ad Supported app. This SERVICE ("app") is provided by at no cost and is intended for use as is.
